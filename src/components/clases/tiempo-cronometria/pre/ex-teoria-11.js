...
import { ReactComponent as Img2 } from "../../../../static/img/clases/tiempo-cronometria/01140023.svg";
...
const ExTeoria11 = () => {
  ...
  useEffect(() => {
    basicTimelineTeoria
      ...
      .add({
        targets: ".teoria11a #segundo",
        opacity: [{ value: [0, 1], duration: 1000, delay: 500 }],
        translateX: [{ value: [0, -500], duration: 1000, delay: 500 }],
      })
      .add(
        {
          targets: ".teoria11a #solucion_2 path",
          opacity: [0, 1],
          duration: (el, i) => {
            return 500;
          },
      ...
      .add({
        targets: ".teoria11a #primero,.teoria11a #segundo, .teoria11a #linea",
        opacity: 1,
        duration: 500,
      });
  }, [basicTimelineTeoria]);
