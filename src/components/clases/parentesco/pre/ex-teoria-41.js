...
import { ReactComponent as Img2 } from "../../../../static/img/clases/parentesco/01290023.svg";
...
const ExTeoria41 = () => {
  ...
  useEffect(() => {
    basicTimelineTeoria
      ...
      .add({
        targets: ".teoria41 #segundo",
        opacity: [{ value: [0, 1], duration: 1000, delay: 500 }],
        translateX: [{ value: [0, -500], duration: 1000, delay: 500 }],
      })
      .add(
        {
          targets: ".teoria41 #solucion_2 path",
          opacity: [0, 1],
          duration: (el, i) => {
            return 500;
          },
      ...
      .add({
        targets: ".teoria41 #primero,.teoria41 #segundo, .teoria41 #linea",
        opacity: 1,
        duration: 500,
      });
  }, [basicTimelineTeoria]);
