...
import { ReactComponent as Img2 } from "../../../../static/img/clases/juegos-ingenio/01320022.svg";
...
const ExTeoria1 = () => {
  ...
  useEffect(() => {
    basicTimelineTeoria
      ...
      .add(
        {
          targets: ".teoria1 #solucion_2 path",
          opacity: [0, 1],
          duration: (el, i) => {
            return 500;
          },
      ...
      .add({
        targets: ".teoria1 #primero,.teoria1 #segundo, .teoria1 #linea",
        opacity: 1,
        duration: 500,
      });
  }, [basicTimelineTeoria]);
