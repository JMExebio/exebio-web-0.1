...
import { ReactComponent as Img2 } from "../../../../static/img/clases/juegos-ingenio/01320033.svg";
...
const ExTeoria21 = () => {
  ...
  useEffect(() => {
    basicTimelineTeoria
      ...
      .add({
        targets: ".teoria21 #segundo",
        opacity: [{ value: [0, 1], duration: 1000, delay: 500 }],
        translateX: [{ value: [0, -500], duration: 1000, delay: 500 }],
      })
      .add(
        {
          targets: ".teoria21 #solucion_2 path",
          opacity: [0, 1],
          duration: (el, i) => {
            return 500;
          },
      ...
      .add({
        targets: ".teoria21 #primero,.teoria21 #segundo, .teoria21 #linea",
        opacity: 1,
        duration: 500,
      });
  }, [basicTimelineTeoria]);
